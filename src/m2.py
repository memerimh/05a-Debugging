...
# ----------------------------------------------------------------------
# DOME 4. Follow the INSTRUCTIONS AT THE TOP OF THIS MODULE
#          to correct the mistake(s) in the following function.
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# DOME: 5. Follow the INSTRUCTIONS AT THE TOP OF THIS MODULE
#          to correct the mistake(s) in the following function.
# ----------------------------------------------------------------------
def broken_3(n, point, length, distance_between_lines, window):
    ...
    for k in range(n):
        a = rg.Point(a.x + k * distance_between_lines, a.y)
        b = rg.Point(b.x + k * distance_between_lines, b.y)
        line = rg.Line(a, b)
